<section class="">
    <div class="mx-auto mt-8 flex flex-col items-center justify-center px-6 py-8 lg:py-0">
        <div
            class="mb-8 w-full rounded-lg bg-white shadow sm:max-w-md md:mt-0 xl:p-0 dark:border dark:border-gray-700 dark:bg-gray-800">
