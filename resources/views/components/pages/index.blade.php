    <main class="container mx-auto mt-7 lg:flex">
        <section class="grow-3 lg:mr-10">
            ...
            {{-- <div>
                <!-- Icon Blocks -->
                <div class="max-w-[85rem] px-6 py-8 mx-auto">
                    <div class="mx-auto">
                        <!-- Grid -->
                        <div class="grid md:grid-cols-2 gap-6 lg:gap-12">
                            <div class="space-y-6 lg:space-y-10">
                                ...
                                <div class="flex gap-x-5 sm:gap-x-8">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="shrink-0 mt-2 size-8 text-gray-800 dark:text-white">
                                ...
                                <div class="flex gap-x-5 sm:gap-x-8">
                                    ...
                                    <svg class="shrink-0 mt-2 size-8 text-gray-800 dark:text-white" version="1.0" xmlns="http://www.w3.org/2000/svg" width="357.000000pt" height="386.000000pt" viewBox="0 0 357.000000 386.000000" preserveAspectRatio="xMidYMid meet">
                                        <g transform="translate(0.000000,386.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                                            <path d="M2418 3386 c-201 -22 -369 -43 -372 -46 -3 -3 42 -59 100 -124 57 -66 104 -122 103 -125 -1 -8 -692 -624 -705 -628 -6 -2 -67 44 -135 102 -67 58 -126 104 -131 103 -8 -3 -1028 -990 -1028 -996 0 -2 3 -1 8 1 253 157 1027 627 1031 627 3 0 61 -48 129 -106 l123 -105 167 144 c92 79 295 255 451 390 156 136 287 247 290 247 3 -1 53 -54 111 -120 58 -65 108 -116 111 -112 4 4 43 169 88 367 45 198 86 375 91 393 8 32 8 32 -28 31 -20 -1 -202 -20 -404 -43z"/>
                                ...
                                <div class="flex gap-x-5 sm:gap-x-8">
                                    ...
                                    <svg class="shrink-0 mt-2 size-8 text-gray-800 dark:text-white" height="800px" width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
		...
		c-13.218,10.023-63.92,28.448-63.92,56.664C96.836,428.217,113.114,431.973,113.114,431.973z"/>
                            ...
                            <div class="space-y-6 lg:space-y-10">
                                ...
                                <div class="flex gap-x-5 sm:gap-x-8">
                                    ...
                                    <svg class="shrink-0 mt-2 size-8 text-gray-800 dark:text-white" width="800px" height="800px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">

                                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <g id="Dribbble-Light-Preview" transform="translate(-220.000000, -2719.000000)" fill="#000000">
                                ...
                                <div class="flex gap-x-5 sm:gap-x-8">
                                    ...
                                    <svg class="shrink-0 mt-2 size-8 text-gray-800 dark:text-white" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
