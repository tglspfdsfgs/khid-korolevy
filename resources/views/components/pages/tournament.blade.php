    ...
    <section class="grow-3 lg:mr-10">
        <div class="format lg:card-side bg-base-100 static mb-5 mt-5 w-full rounded-lg px-4 py-5 shadow-sm">
            ...
            <p>
                ...
                @endif
                @if ($data["hasResults"])
                    <a href='{{ "/tournament/" . $data["tournamentID"] . "/results" }}'
                ...
                @endif
                @if ($data["hasGallery"])
                    <a href='{{ "/tournament/" . $data["tournamentID"] . "/gallery" }}'
        ...
        <x-blocks.submit-buttons :state='$data["state"]' :editor-link='"/tournament/" . $data["tournamentID"] . "/edit"' />
    </section>
