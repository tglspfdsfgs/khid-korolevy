...
<main class='{{ ($isResponsive ? " container lg:flex " : " $unresponsiveSize flex ") . " mx-auto mt-7 lg:flex "}}'>
    <section class="grow-3">
        <div class="format lg:card-side bg-base-100 static mb-25 mt-5 w-full rounded-lg px-4 py-5 shadow-sm">
            <p>
            ...
            <x-blocks.submit-buttons
                    ...
                    :is-nested-resource="true"
                    :editor-link='"/tournament/" . $data["id"] . "/results/edit"'
            />
    </section>
