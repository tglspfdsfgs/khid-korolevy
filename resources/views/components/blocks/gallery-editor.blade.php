    ...
    <div class="border-b border-gray-200 px-3 py-2 dark:border-gray-600">
        <div class="flex flex-col items-start">
            <div class="flex flex-wrap items-center space-x-1 pl-4 rtl:space-x-reverse">
                ...
                <button type="button" data-tooltip-target="tooltip-add-gallery" data-modal-target="add-gallery"
                    data-modal-toggle="add-gallery"
                    class="cursor-pointer rounded-sm p-1.5 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="h-9 w-9" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path
                    ...
                    <span class="sr-only">Add gallery</span>
                </button>
                <div id="tooltip-add-gallery" role="tooltip"
                    class="shadow-xs tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 transition-opacity duration-300 dark:bg-gray-700">
                    Додати галерею
                    <div class="tooltip-arrow" data-popper-arrow></div>
                </div>
                {{-- GALLERY MODAL ↓↓↓ --}}
                <div id="add-gallery" tabindex="-1" aria-hidden="true"
                    class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0">
                    <div class="relative max-h-full w-full max-w-md p-4">
                        <!-- Modal content -->
                        <div class="relative rounded-lg bg-white shadow-sm dark:bg-gray-700">
                            ...
                            <!-- Modal body -->
                            <div class="p-4 md:p-5">
                                <form id="addGalleryForm" class="space-y-4" action="#">
                                    <div>
                                        <label for="URL"
                                            class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">YouTube
                                            URL</label>
                                        <input type="url" name="url" id="URL"
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                                            value="https://www.youtube.com/watch?v=KaLxCiilHns" required />
                                    </div>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label for="width"
                                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Video
                                                width</label>
                                    ...
                                    <button type="submit" id="addAdvancedVideoButton"
                                        class="w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add
                                        video</button>
                                </form>
                            </div>
                        </div>
