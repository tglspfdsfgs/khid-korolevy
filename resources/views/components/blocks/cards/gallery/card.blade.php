@php
    extract($props);
    use App\Enums\GalleryType as Type;
@endphp
...
<div class="card lg:card-side bg-base-100 relative mb-5 p-5 shadow-sm md:grid md:grid-cols-[1fr_3fr]">
    ...
    <div class="card-body lg:pt-0">
        ...
        <i class="badge badge-sm">
            ...
            @if (Type::isTournament(Type::from($galleryType)))
                Дата турніру:
            @else
                Дата публікації:
            @endif
        ...
        <b class="badge badge-sm">
            [ {{ \App\Enums\GalleryType::title($galleryType) }} ]
        </b>
    ...
    <x-blocks.cards.edit-btn link='{{ "/gallery/" . $id . "/edit" }}' />
