...
<div class="container mx-auto">
  ...
  c-13.218,10.023-63.92,28.448-63.92,56.664C96.836,428.217,113.114,431.973,113.114,431.973z" />
            ...
            <a class="text-base-content hover:bg-base-300 focus:outline-hidden focus:bg-base-200 group flex flex-col justify-center rounded-xl p-4 md:p-4"
                ...
                <div class="flex items-center justify-center">
                    <svg class="mt-2 size-12 shrink-0 text-gray-800 dark:text-white" fill="currentColor" height="800px"
                        width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
                        <g>
                            <path d="M34.209,152.142v208.084c0,16.773,8.802,32.311,23.186,40.947l174.048,104.392
  ...
  C54.019,323.952,63.793,319.507,75.841,326.077z" />
                            <path d="M473.993,133.524L265.864,258.366c-2.494,1.492-4.024,4.19-4.024,7.099V512
  ...
  c0-12.056,9.765-27.157,21.822-33.728s21.837-2.125,21.837,9.931C453.249,226.191,443.468,241.292,431.412,247.87z" />
                            <path d="M454.605,111.204L280.557,6.804C272.992,2.268,264.507,0,256.001,0c-8.508,0-16.992,2.268-24.557,6.796
 ...
 c0,0,0,0,0,0c-1,0.3-2,0.4-3.1,0.4S13.9,27.8,12.9,27.6z" />
  ...
  c-13.218,10.023-63.92,28.448-63.92,56.664C96.836,428.217,113.114,431.973,113.114,431.973z" />
                    ...
                    <a href="{{ $links["tabletop tournaments"] }}"
                        class="text-base-content hover:bg-base-300 focus:outline-hidden focus:bg-base-200 group mb-4 flex gap-x-5 rounded-xl px-2 py-4 sm:gap-x-8">
                        <svg class="ml-4 mt-2 size-8 shrink-0 text-gray-800 dark:text-white" fill="currentColor"
