...
<div>
    <header
        class='{{ ($isResponsive ? " w-full max-md:hidden " : $unresponsiveSize . " max-md:hidden mx-auto ") . " p-5 inset-0 bg-cover bg-center bg-repeat" }}'
    ...
    <div class='{{ ($isResponsive ? " bg-accent " : " ") . " text-accent-content " }}'>
        <div class='{{ ($isResponsive ? " md:container " : $unresponsiveSize) . " mx-auto " }}'>
            <div class="drawer bg-accent text-accent-content">
                ...
                <div class="drawer-content flex flex-col">
                    <!-- Navbar -->
                    <div class='{{ " navbar  " . ($isResponsive ? " md:container mx-auto " : $unresponsiveSize) }}'>
