...
<div>
    <header class='{{ ($isResponsive ? " w-full max-md:hidden " : ($unresponsiveSize . " mx-auto ")) . " p-5 inset-0 bg-cover bg-center bg-repeat"}}'
        style="background-image: url('{{ Vite::asset("resources/images/header-image.jpg") }}')">

        <div class='{{ ($isResponsive ? " mx-auto ": " ") . "container flex flex-row justify-between"}}'>
            <a href='{{ route("index") }}'>
